main.floors.MT62=
{
    ...
    "firstArrive": [
        ...
        "\t[系统提示]习得新技能：烟幕、Z字规避",
        "\t[系统提示]烟幕（50指挥点）：释放烟幕，下一场与敌方水面战舰的战斗期间，获得20%炮火伤害减免，但我方普攻伤害也会减少10%（鱼雷伤害不会减少）。仅可在海上地图中使用。",
    ...
    "events": {
        ...
        "7,0": [
            ...
            "\t[系统提示]当前区域敌人特点：均为海军，包括潜艇、驱逐舰和巡洋舰，前两者居多\n推荐携带技能：紧急补给、防空弹幕、空战王牌、烟幕、Z字规避\n推荐出战装备："
        ],
        "14,2": [
    ...
    "cannotMoveIn": {},
    "map": [
    [  0,30671,  0,  0,30308,  0,  0,10301,517,  0,  0,  0,  0,30534,30535],
    [  0,30679,  0,  0,30316,  0,  0,  0,  0,  0,  0,  0,  0,30542,30543],
    [30588,30604,  0,  0,  0,  0,  0,30516,30517,  0,  0,  0,  0,  0,516],
    [30596,30612,  0,  0,  0,  0,  0,30524,30525,  0,  0,  0,  0,  0,  0],
    ...
    [300,300,300,300,556,300,300,300,300,300,300,300,300,300,300],
    [300,300,300,300,300,300,300,300,300,300,300,300,300,300,300],
