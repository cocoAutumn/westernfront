main.floors.MT310=
{
    ...
    "firstArrive": [
        ...
        "\t[系统提示]习得新技能：T34谢尔曼风琴",
        "\t[系统提示]\f[skill20.jpg,170,50]T34谢尔曼风琴（600指挥点）：仅可在地面使用。呼叫火箭炮覆盖打击，打击目标为以自身为中心7×7正方形区域，其中的敌人陆军受到不同程度的损失：步兵失去70%生命值，炮兵失去50%，装甲失去20%",
        "\t[历史来源]\f[skill20.jpg,170,50]M4/T34是谢尔曼坦克各类型号中最具辨识度的存在，头顶搭载了一门火箭炮，既可以像常规坦克一样突击，也可以进行炮火支援，也叫“卡利欧波”（calliope，译为管风琴）。火箭炮有36到60支炮管，可以发射114.3毫米（4.5英寸）火箭炮，最大射程约3800米（后期采用旋转稳定式M16火箭弹时可达4800米），诺曼底登陆后广泛用于战场。（为避免与苏联T-34系列坦克混淆，苏联坦克的T通常用俄语发音来读，即te四声）",
        {
            "type": "hide",
            "remove": true
        }
