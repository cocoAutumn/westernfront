main.floors.MT26=
{
    ...
    "firstArrive": [
        ...
        "\t[系统提示]目前，由于鱼雷引信存在严重的质量问题，导致美军舰艇和飞机发射的鱼雷中，十有八九都是哑弹。因此，除神剧难度外，不要指望美国鱼雷能够打出伤害。",
        "\t[系统提示]但这并不代表美国货完全不能用。对于不使用鱼雷攻击的作战单位来说，这一致命缺点便不复存在，且游戏中后期的商店将会出售能够解决“哑弹”问题的选项。不过就现在来说，最好还是以英国武器为主，尤其鱼雷。"
    ],
    "eachArrive": [],
    "parallelDo": "",
    "events": {
