var data_a1e2fb4a_e986_4524_b0da_9b7ba7c0874d = 
{
	...
	"firstData": {
						...
						"data": [
							...
							},
							{
								...
								"action": [
									...
									"\t[鱼雷轰炸机,ju87b]\b[down,null]挂载鱼雷，专门攻击军舰的飞机。但投放鱼雷时必须放慢速度，低空飞行，导致它们很容易被击落。",
									"\t[中型轰炸机,ju87b]\b[down,null]标准的轰炸机，能挂载大量炸弹进行水平轰炸，但精度比较低。",
									"\t[战略轰炸机,ju87b]\b[down,null]翱翔在高空中的巨大飞机，拥有能让一座城市瞬间化为火海的恐怖战力，但精度极差，且依赖战斗机的保护。"
								]
							}
						]
					}
		...
		"startText": [
			...
			{
				"type": "function",
				"function": "function(){\ncore.addItem('book');core.addItem('fly');\n}"
			},
			{
				"type": "sleep",
				"time": 500
