	...
	"main": {
		...
		"levelChoose": [
			...
			},
			{
				...
				"action": [
					"\t[炼狱难度]难度系数：5。由于无人测试过，尚不清楚是否有解（应该是有的）。有实力的大佬可以尝试一下。",
					{
						"type": "confirm",
						"text": "确定选择炼狱难度？",
						"yes": [],
				...
				"data": [
					{
						...
						"data": [
							...
							},
							{
								...
								"action": [
									"\t[步兵,scoutinf]\b[down,null]基础兵种，战斗力较低，但会在战场上发挥多种多样的技能，常常出奇制胜。",
									"\t[轻型坦克,ab41]\b[down,null]以大口径机枪或速射炮作为主要武器，机动灵活，适合侦察。",
									"\t[中型坦克,panzer3e]\b[down,null]装甲部队的重要战力，无论是火炮还是装甲都比较优秀。",
									"\t[重型坦克,tigere]\b[down,null]能够以一敌百的战场“巨无霸”，战斗力极强，但数量很少且油耗很大。",
									"\t[坦克歼击车,stug3a]\b[down,null]牺牲了装甲防护换来更强有力的火炮，是坦克中的狙击手。",
									"\t[反坦克炮,pak36]\b[down,null]专门用来摧毁坦克的火炮，具有相对不错的穿甲能力。",
									...
									"\t[航空母舰,zeppelin]\b[down,null]尚未经历实战检验的新型军舰，使用舰载机作为主要武器，也许会取代战列舰成为新的海上霸主？",
									"\t[战斗机,me109e4]\b[down,null]轻盈灵巧的空中作战单位，是夺取制空权的主力。",
									"\t[重型战斗机,me110c]\b[down,null]通过牺牲机动性，换来更强的火力和战场生存能力，最喜欢欺负落单的轰炸机。",
									"\t[俯冲轰炸机,ju87b]\b[down,null]载弹量较小的轻型轰炸机，通过俯冲投弹来换取更高的精准度。多数俯冲轰炸机可以从航空母舰上起飞。",
									"\t[鱼雷轰炸机,do17z]\b[down,null]挂载鱼雷，专门攻击军舰的飞机。但投放鱼雷时必须放慢速度，低空飞行，导致它们很容易被击落。",
									"\t[中型轰炸机,ju88a]\b[down,null]标准的轰炸机，能挂载大量炸弹进行水平轰炸，但精度比较低。",
									"\t[战略轰炸机,evilFairy]\b[down,null]翱翔在高空中的巨大飞机，拥有能让一座城市瞬间化为火海的恐怖战力，但精度极差，且依赖战斗机的保护。"
								]
							}
						]
					}
				...
				"choices": [
					...
					},
					{
						...
						"action": [
							...
							"\f[spitfiremk1.jpg,170,50]装备属性：攻击+60，与战斗机作战时，每回合额外追加10%伤害",
							{
								"type": "confirm",
								"text": "确定购买？",
								"yes": [
				...
				"choices": [
					...
					},
					{
						...
						"action": [
							...
							"2级研发。研发项目：主动发出声波并监听回音，以探测水下物体的军用设备",
							{
								"type": "confirm",
								"text": "确定购买？",
								"yes": [
