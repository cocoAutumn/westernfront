var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"enterprise": {
		...
		"name": "企业号航空母舰",
		"canUseItemEffect": "true",
		"text": "攻击力+n%，后勤+m%。舰载机：F4U海盗式战斗机、SB2C地狱俯冲者轰炸机、TBF复仇者鱼雷机\n被动：\n灰色幽灵：我军一切空袭伤害×250%，与除潜艇外的敌方海空军交战时，伤害提升50%，受伤降低30%。\n远程空袭：无视敌军战列舰主炮伤害，且可以支援我军在陆地上的行动。\nLucky E：装备企业号时，“海上霸主”技能花费改为2500，效果改为“当前地图所有除潜艇外的敌舰和飞机损失90%血量，陆军损失60%”。\n先发制人：舰载机在战斗首回合即可投放炸弹和鱼雷。"
	},
	"wrestler": {
		"cls": "equips",
		"name": "斗士MK2型",
	...
	"sb2c": {
		...
		"name": "SB2C地狱俯冲者",
		"canUseItemEffect": "true",
		"text": "主武器：2×20mm机炮和2×7.62mm自卫机枪。挂载：8×HVAR火箭弹和1×2000磅炸弹或1×MK13鱼雷\n属性：攻击+n，雷击+n%。与陆军和水面舰艇作战时抢先发射火箭弹，每枚火箭弹伤害为0.2倍攻击力。每4回合投弹2次，每颗炸弹伤害为8倍攻击力。\n被动：\n地狱咆哮：敌人攻击力减少15%，鱼雷闪避-2。对重巡和战列舰造成的炸弹伤害增加50%。\n双重打击：攻击军舰时，可以在投弹的同时发射3枚鱼雷攻击。\n哑弹：发射的鱼雷不会爆炸。"
	},
	"tempest": {
		"cls": "equips",
		"name": "暴风式攻击机",
